...
namespace Pedantic.Chess
{
    public sealed partial class Board
    {
        ...
        public static ulong GetRookAttacksFancy(int s, ulong occ)
        {
            return lookup_Table[rIndex(s, occ)];
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong GetBishopAttacksFancy(int s, ulong occ)
        {
            ...
            for (int x = 0; x < 8; x++)
            {
                for (int y = 0; y < 8; y++)
                {
                    ...
                    for (ulong i = 0; i < (ulong)(1 << cnt); i++)
                    {
                        ...
                        lookup_Table[rIndex(sq, occ)] = GetRookAttacks(sq, occ);
                    }
                    ...
                    for (ulong i = 0; i < (ulong)(1 << cnt); i++)
                    {
                        ...
                        lookup_Table[bIndex(sq, occ)] = GetBishopAttacks(sq, occ);
                    }
                }
            }
        }
